...
train_session_dir = os.path.join(args.save_dir, f"SegResnet_enn_train_session_{formatted_time}")
os.makedirs(train_session_dir, exist_ok=True)

data_dir = args.data_dir
pet_dir = os.path.join(data_dir, 'MSUV_cropped')
ct_dir = os.path.join(data_dir, 'MCTres_cropped')
mask_dir = os.path.join(data_dir, 'MSEG_cropped')
...
trained_model_path = "./models/pretrained_model.pth"  # path to the pretrained ResNet model
model.load_pretrained_segresnet(trained_model_path)
